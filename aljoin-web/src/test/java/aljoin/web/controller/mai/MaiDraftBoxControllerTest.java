...
public class MaiDraftBoxControllerTest extends BaseTest{
	...
	public void testAdd() throws Exception {
		String uri = "http://localhost:8080/mai/maiDraftBox/add";
		MockHttpServletRequestBuilder mhsrb = MockMvcRequestBuilders.post(uri);
		
		mhsrb.param("create_user_id", "903158226865868800");
		...
		mhsrb.param("subjectText", "测试2(只有发件人能看的)草稿第1封");
		mhsrb.param("mailContent", "测试2(只有发件人能看的)我们不预测未来，我们创造未来。");
	...
	public void testList() throws Exception {
		String uri = "http://localhost:8080/mai/maiDraftBox/list";
		MockHttpServletRequestBuilder mhsrb = MockMvcRequestBuilders.post(uri);
	...
	public void testUpdate() throws Exception {
		String uri = "http://localhost:8080/mai/maiDraftBox/update";
		MockHttpServletRequestBuilder mhsrb = MockMvcRequestBuilders.post(uri);
	...
	public void testDelete() throws Exception {
		String uri = "http://localhost:8080/mai/maiDraftBox/delete";
		MockHttpServletRequestBuilder mhsrb = MockMvcRequestBuilders.post(uri);
		mhsrb.param("id", "910372629004505999");
	...
	public void testGetById() throws Exception {
		String uri = "http://localhost:8080/mai/maiDraftBox/getById";
		MockHttpServletRequestBuilder mhsrb = MockMvcRequestBuilders.post(uri);
		mhsrb.param("id","912154643198210048");
		MvcResult mvcResult = mvc.perform(mhsrb.accept(MediaType.APPLICATION_JSON)).andReturn();
		int status = mvcResult.getResponse().getStatus();
		String content = mvcResult.getResponse().getContentAsString();
		InterfaceObject io = new InterfaceObject();
