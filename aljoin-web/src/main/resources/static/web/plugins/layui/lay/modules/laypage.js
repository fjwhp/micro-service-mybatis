...
layui.define(function(a) {
    ...
    p.prototype.view = function() {
        ...
        function() {
            return t.skip ? '<span class="layui-laypage-total">共' + t.total + '行&nbsp;&nbsp;&#x5230;&#x7B2C; <input type="number" min="1" value="' + t.curr + '" class="layui-laypage-skip"> &#x9875;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="layui-laypage-btn">&#x786e;&#x5b9a;</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;每页显示&nbsp;&nbsp;&nbsp;<select class="layui-laypage-pagesize" style="height:26px;width:48px;border:solid 1px #ccc;"><option value="10">10</option><option value="20">20</option><option value="30">30</option><option value="40">40</option value="50"><option>50</option></select>&nbsp;&nbsp;&nbsp;条</span>': ""
        } () + "</div>"
    },
