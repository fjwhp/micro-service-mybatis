...
var readReceipt = {
     ...
     * @param bizId    业务表主键ID
     */
    completeTask: function (isOffice) {
...
//        tool.post("/ioa/ioaReceiveFile/getAllTaskInfo", pm, function (data) {
    ...
    readDetail: function (bizId) {
        ...
        if (null != object) {
            ...
            for (var key in object) {
                $("#read-object-form").find("#" + key + "-read").val(object[key]);
    ...
    toReadDetail: function (bizId) {
        ...
        if(object.resResourceList == null){
        	$("#demoList-toread").parents(".table-wrap").parent(".office-opinion").remove();
        }
        if (null != object) {
        	//文件附件
        	if (null != object.resResourceList) {
            ...
            if (null != object.objectDOList) {
                ...
                for(var i = 0;i < obj.length;i++){
                    if(obj[i].isCheck == "1"){
                        ...
                        $("#all-detail").parent().parent().parent().show();
                    }else{
                    	$("#all-detail").parent().parent().parent().hide();
                    }
                }
    ...
    directorAuditDetail: function (bizId) {
        ...
        //附件为空移除附件结构
        if(object.resResourceList == null){
        	$("#demoList-director").parents(".table-wrap").parent(".office-opinion").remove();
        }
        if (null != object) {
            if (null != object.resResourceList) {
                var fileBack = object.resResourceList;
    ...
    registerDetail: function (bizId) {
        ...
        //附件为空移除附件结构
        if(object.resResourceList == null){
        	$("#demoList-register").parents(".table-wrap").parent(".office-opinion").remove();
        }
        //默认签收
        if (null != object) {
            if (null != object.resResourceList) {
            ...
            for (var key in object) {
                ...
                $("#inRead-object-form-object-form").find("#" + key + "-inread").text(
                    object[key]);
                if (key == 'orgnlFileTime') {
                    var orgnlFileTime = object[key].substr(0, 10);
                    $("#orgnlFileTime-inread").text(orgnlFileTime);
     ...
     * 打印
     */
    print : function (printIdStr) {
    	$("form").css("display","none");
    	$("#"+printIdStr).find("#btns").css("display","none");
    	$("#"+printIdStr).show();
        window.print();
        $("form").css("display","block");
        $("#"+printIdStr).find("#btns").css("display","block");
         return false;
     }
