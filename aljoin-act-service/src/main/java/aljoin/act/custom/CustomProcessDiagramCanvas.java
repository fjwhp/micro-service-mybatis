...
public class CustomProcessDiagramCanvas {
    ...
    protected static Color HIGHLIGHT_COLOR = new Color(51, 161, 255);
    protected static Color HIGHLIGHT_COLOR2 = Color.RED;// 活动节点颜色
    ...
    // Fonts
    protected static Font LABEL_FONT = new Font("微软雅黑", Font.PLAIN, FONT_SIZE);;
    ...
    public void initialize(String imageType) {
        ...
        LABEL_FONT = new Font(labelFontName, Font.PLAIN, 12);
    ...
    public void drawHighLight(int x, int y, int width, int height, int radius) {
        Paint originalPaint = g.getPaint();
        Stroke originalStroke = g.getStroke();
        ...
        RoundRectangle2D rect = new RoundRectangle2D.Double(x, y, width, height, radius, radius);
        g.draw(rect);
    ...
    public void drawHighLight2(int x, int y, int width, int height, int radius) {
        Paint originalPaint = g.getPaint();
        Stroke originalStroke = g.getStroke();

        g.setPaint(HIGHLIGHT_COLOR2);
        g.setStroke(THICK_TASK_BORDER_STROKE);
