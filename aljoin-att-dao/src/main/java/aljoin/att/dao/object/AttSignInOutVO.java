 ...
 * @date： 2017-09-27
 */
public class AttSignInOutVO extends AttSignInOut {
     ...
     * 本月
     */
    @ApiModelProperty(value = "本月", required = false, hidden = true)
    ...
    public String getQueryYM() {
        return queryYM;
    }

    public void setQueryYM(String queryYM) {
