 ...
 * @date：2017年7月25日
 */
public class ContactFiveCity extends BaseFormSoure {
	@Override
	public List<Object> execute(Map<String, String> paramMap) throws Exception {
		...
		ContactSelectSource source5 = new ContactSelectSource();
		source5.setId("5");
		source5.setText("38hao");
		source5.setLevel("5");
		source5.setParent("4");
		source5.setCheck(false);

		contactSelect.add(source);
		contactSelect.add(source2);
		contactSelect.add(source3);
		contactSelect.add(source4);
		contactSelect.add(source5);
