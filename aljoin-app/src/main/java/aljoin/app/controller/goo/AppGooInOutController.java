package aljoin.app.controller.goo;
 ...
 */
@Controller
@RequestMapping(value = "/app/goo/gooInOut", method = RequestMethod.POST)
@Api(value = "办公用品出入库Controller", description = "办公用品出入库相关接口")
public class AppGooInOutController extends BaseController {

	private final static Logger logger = LoggerFactory.getLogger(AppGooInOutController.class);
	...
	public RetMsg completeTask(HttpServletRequest request, HttpServletResponse response, String taskId, String bizId,
		...
		try {
			...
			retMsg = gooInOutService.completeAppTask(variables, taskId, bizId, userId, message, autUser);
